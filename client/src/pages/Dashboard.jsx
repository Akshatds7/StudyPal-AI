...
import './Dashboard.css'; // CSS file you'll create next
...
return (
    <div style={{ padding: 40 }}>
      ...
      <input type="text" placeholder="Subjects (comma-separated)" value={subjects} onChange={(e) => setSubjects(e.target.value)} />
      <input type="number" placeholder="Hours per day" value={hours} onChange={(e) => setHours(e.target.value)} />
      <input type="number" placeholder="Number of days" value={days} onChange={(e) => setDays(e.target.value)} />
      <button onClick={generatePlan}>Generate Plan</button>

      <button onClick={handleLogout} style={{ marginTop: 20, backgroundColor: '#dc3545' }}>Logout</button>
